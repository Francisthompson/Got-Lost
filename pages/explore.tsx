  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <h1 className="text-4xl font-bold mb-4">Explore Campus</h1>
        <p className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {scenes.map((scene) => (
            <div
              key={scene.id}
              className="bg-base-100 border border-base-300 dark:bg-base-300 dark:border-neutral rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow"
            >
