    ...
    <div className="min-h-screen">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold mb-6">About Got Lost?</h1>
          
          <div className="bg-base-100 dark:bg-base-300 rounded-lg shadow-md p-8 mb-6">
            <h2 className="text-2xl font-semibold mb-4">
              Welcome to Got Lost?
            </h2>
            <p className="bg-base-100 dark:bg-base-300 mb-4">
          ...
          <div className="bg-base-100 dark:bg-base-300 rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-semibold mb-4">
              Technology Stack
            </h2>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-2">360° Viewer</h3>
                <ul className="space-y-1">
                  <li>• Pannellum</li>
                  <li>• React Hooks</li>
